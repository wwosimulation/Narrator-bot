module.exports = {
    ...
    run: async (message, args, client) => {
        ...
        let button1 = { type: 2, style: 3, label: "Restart/Update", custom_id: "dev-restart", disabled: false }
        ...
        let button4 = { type: 2, style: 2, label: "Toggle Maintenance", custom_id: "dev-maintenance", disabled: false }
        let row = { type: 1, components: [button1, button2, button3, button4] }
