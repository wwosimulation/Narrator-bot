...
module.exports = {
    ...
    run: async (message, args, client) => {
        if (message.channel.name == "priv-corruptor") {
            ...
            if (!message.member.roles.cache.has(client.config.ids.alive)) return message.channel.send("If i let you do that, I'd be more corrupt than you...")
            ...
            if (!guy.roles.cache.has(client.config.ids.alive)) return message.channel.send("So you want to glitch someone who can't talk or vote. Very usefull. Here's another tip: `+suicide` kills all players and makes you win alone!")
