...
module.exports = {
  ...
  run: async(message, args, client) => {
    if (message.channel.name == 'priv-sect-hunter') {
      ...
      if (!guy.roles.cache.has(client.config.ids.alive) || !ownself.roles.cache.has(client.config.ids.alive)) return await message.channel.send('You can\'t hunt if you or your target is dead dumb.') 
