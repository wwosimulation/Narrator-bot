module.exports = {
    ...
    run: async (message, args, client) => {
        if (args[0] == "rrv") {
            ...
            let rww = ["Werewolf", "Junior Werewolf", "Nightmare Werewolf", "Wolf Pacifist", "Wolf Shaman", "Kitten Wolf", "Shadow Wolf", "Guardian Wolf", "Werewolf Berserk", "Alpha Werewolf", "Wolf Seer"]
        } else if (args[0] == "rvoting") {
            let rvoting = ["Fool", "Headhunter"]
        } else if (args[0] == "rsk") {
            let rsk = ["Serial Killer", "Corruptor", "Arsonist", "Bomber", "Illusionist", "Cannibal", "Sect Leader", "Lone Wolf", "Bandit", "Sect Leader\n\nReroll if this role was rolled before", "Zombie"]
