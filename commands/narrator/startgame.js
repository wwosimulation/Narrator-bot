...
module.exports = {
    ...
    run: async (message, args, client) => {
        ...
        zombchat.forEach(async (zomb) => {
            await wwchat.permissionOverwrites.edit(zomb, { SEND_MESSAGES: true, VIEW_CHANNEL: true, READ_MESSAGE_HISTORY: true })
        })
        sibchat.forEach(async (sib) => {
            await wwchat.permissionOverwrites.edit(sib, { SEND_MESSAGES: true, VIEW_CHANNEL: true, READ_MESSAGE_HISTORY: true })
        })
