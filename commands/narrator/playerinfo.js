...
module.exports = {
    ...
    run: async (message, args, client) => {
        ...
        message.channel.send(new Discord.MessageEmbed().setTitle("Playerinfo").setDescription(content).setColor("#648620")).catch((e) => message.channel.send(`An error occured: ${e.message}`))
    },
}
