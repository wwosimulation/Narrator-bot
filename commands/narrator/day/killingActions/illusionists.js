...
async function getProtections(client, guy, attacker) {
    ...
    if (typeof getResult !== "object") {
        ...
        // check if the player they are attacking is healed by the surrogate
        getResult = await surrogate(client, guy, attacker) // checks if a surrogate is protecting them
