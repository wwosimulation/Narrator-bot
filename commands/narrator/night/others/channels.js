...
module.exports = async (client) => {
    ...
    const vote_channel = client.channels.cache.find((c) => c.name === "vote-chat") // get the vote chat channel - Object
    ...
    players.forEach(async (player) => {
        ...
        if (!guy.nightmared || !guy.jailed || !guy.hypnotized) {
            ...
            } else if (guy.team === "Werewolf" && guy.role !== "Sorcerer" && guy.role !== "Werewolf Fan" && guy.status === "Alive") {
