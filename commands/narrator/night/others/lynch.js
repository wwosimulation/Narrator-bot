...
module.exports = async (client) => {
    ...
    if (sortedVotes.length === 0 || db.get(`game.noVoting`)) sortedVotes = [[alivePlayers[Math.floor(Math.random() * alivePlayers.length)]]]
    ...
    if (condition && db.get(`game`).gamemode !== "forcevote") {
