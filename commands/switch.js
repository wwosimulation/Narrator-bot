...
module.exports = {
    ...
    run: async (message, args, client) => {
        if (message.channel.name == "priv-naughty-boy") {
            ...
            if (!message.member.roles.cache.has(client.config.ids.alive)) return message.channel.send("You aren't alive dumb.")
            ...
            if (!guy1.roles.cache.has(client.config.ids.alive) || !guy2.roles.cache.has(client.config.ids.alive)) return message.channel.send("One of the player or both of them aren't alive smart-ass")
