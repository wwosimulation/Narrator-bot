...
module.exports = {
    ...
    run: async (message, args, client) => {
        if (message.channel.name == "priv-marksman") {
            ...
            if (!message.member.roles.cache.has(client.config.ids.alive)) return message.channel.send("You can't mark when your dead punk.")
            ...
            if (!guy.roles.cache.has(client.config.ids.alive)) return message.channel.send("No. Marking dead users make you look stupid.")
