...
module.exports = {
    ...
    run: async (message, args, client) => {
        ...
        if (player.team === "Village" && gamePhase === 1 && player.role !== "Mayor") return await message.channel.send("You can only reveal after the discussion phase on day 1!")
        ...
        if (player.role === "Mayor") {
            ...
            let r = db.get(`game`).revealedPlayers | []
            r.push(target)
            db.set(`game.revealedPlayers`, target)
