...
module.exports = {
    ...
    run: async (message, args, client) => {
        if (message.member.permissions.has("MANAGE_CHANNELS")) {
            ...
            message.channel.send({ embeds: [new MessageEmbed({ color: "DARK_ORANGE", title: "Are you sure you want to flee from the game?", description: "You will get a game warn if you flee from the game." })], components: [row] }).then((msg) => {
