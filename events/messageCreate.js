...
module.exports = (client) => {
  ...
  `)
        ...
        client.channels.cache.get("832884582315458570").send(Discord.Util.cleanContent(`Command ran: **${commandName}**\nArguments: **${args.join(" ") || "None"}**\nAuthor: ${message.author.tag} (${message.author.id})`, message.channel))
